...
namespace Wyrobot.Core.Models
{
    ...
    public class Ban
    {
        ...
        public Ban(ulong userId = default, ulong guildId = default, DateTime issuedAt = default, DateTime expiresAt = default, string username = default, string reason = default)
        {
            UserId = userId;
            GuildId = guildId;
            IssuedAt = issuedAt;
    ...
    public class ExpiredBan : Ban
    {
        public ExpiredBan(ulong userId, ulong guildId)
        {
            UserId = userId;
            GuildId = guildId;
        }
